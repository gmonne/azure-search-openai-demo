...
import pmimage from "../../pages/chat/PMMentor.png";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={pmimage} alt="React" width="300" height="auto" />
                            <h1 className={styles.chatEmptyStateTitle}>Chat with your Project Management Docs</h1>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. what is the meaning of lag in scheduling?)"
                            disabled={isLoading}
