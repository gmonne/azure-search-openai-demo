...
def test_chat(page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Type a new question (e.g. what is the meaning of lag in scheduling?)").click()
    page.get_by_placeholder("Type a new question (e.g. what is the meaning of lag in scheduling?)").fill(
